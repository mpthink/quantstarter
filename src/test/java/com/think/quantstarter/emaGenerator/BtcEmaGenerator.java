...
public class BtcEmaGenerator {
    ...
    @Test
    public void generateEmaForBtc5m() throws ParseException {
        generateEMA5m(5);
        generateEMA5m(10);
        generateEMA5m(20);
    }
    ...
    private void generateEMA5m(int ema) throws ParseException {
        ...
        while (DateUtils.parseUTCTime(start).before(new Date())){
            ...
            BtcCandles5m latest = btcCandles5mMapper.selectById(start);
            if(latest == null){
                return;
            }
    ...
    @Test
    public void generateEmaForBtc1h() throws ParseException {
        generateEMA1h(5);
        generateEMA1h(10);
        generateEMA1h(20);
    }
    ...
    @Test
    public void generateEmaForBtc4h() throws ParseException {
        generateEMA4h(5);
        generateEMA4h(10);
        generateEMA4h(20);
    }
    ...
    private void generateEMA1h(int ema) throws ParseException {
        ...
        wrapper.orderByAsc("candle_time");
        wrapper.last("limit 1");
        BtcCandles1h oldest = btcCandles1hMapper.selectOne(wrapper);
        switch (ema){
            case 5:
                oldest.setEma5(oldest.getClose());
                break;
        ...
        while (DateUtils.parseUTCTime(start).before(new Date())){
            ...
            BtcCandles1h latest = btcCandles1hMapper.selectById(start);
            if(latest == null){
                return;
            }
            List<Double> datas = new ArrayList<>();
    ...
    private void generateEMA4h(int ema) throws ParseException {
        ...
        wrapper.orderByAsc("candle_time");
        wrapper.last("limit 1");
        BtcCandles4h oldest = btcCandles4hMapper.selectOne(wrapper);
        switch (ema){
            case 5:
                oldest.setEma5(oldest.getClose());
                break;
        ...
        while (DateUtils.parseUTCTime(start).before(new Date())){
            ...
            BtcCandles4h latest = btcCandles4hMapper.selectById(start);
            if(latest == null){
                return;
            }
            List<Double> datas = new ArrayList<>();
